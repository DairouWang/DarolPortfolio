                                ...
                                <div className="relative flex items-center">
                                    ...
                                    {showTooltip && (
                                        <motion.div
                                            ...
                                            exit={{ opacity: 0, y: -10 }}
                                            className="absolute left-5 bottom-5 z-50 w-72 bg-black text-white p-4 rounded-lg shadow-xl"
                                        >
                                            ...
                                            <div className="absolute -bottom-1.5 left-3 w-3 h-3 bg-black transform rotate-45"></div>
                                        </motion.div>
                                    )}
                                </div>
                            </div>
