        ...
        <main className="min-h-screen bg-[#FAFAFA]">
            ...
            >
                <div className="w-full px-4 sm:px-5 py-3 sm:py-4 flex justify-between items-center">
                    <Link href="/" className="text-lg sm:text-xl font-bold text-black hover:text-[#f9674d] transition-colors duration-300">
                        Dairou Wang&apos;s Portfolio
                    </Link>
                    <Link 
                        href="/#works" 
                        className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs font-medium uppercase tracking-wider text-gray-600 hover:text-[#f9674d] transition-colors duration-300"
                    >
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-3 sm:mb-4">
                            ...
                            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-black">Diet Dice</h1>
                        </div>
            ...
            {/* Cover Image */}
            <motion.section 
                className="px-4 sm:px-5 py-6 sm:py-8"
            ...
            <section className="py-12 sm:py-14 md:py-16">
                <div className="max-w-3xl mx-auto px-4 sm:px-5">
                    ...
                    >
                        <Link href="/#works">
                            <motion.button
                                className="px-5 sm:px-6 md:px-7 py-2.5 sm:py-3 rounded-full border-2 border-[#f9674d] text-[#f9674d] hover:bg-[#f9674d] hover:text-white transition-all duration-300 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-medium"
