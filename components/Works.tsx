            ...
            <div className={`flex gap-7 items-center ${index % 2 === 1 ? 'flex-row-reverse' : ''}`}>
                ...
                <div className="w-1/2 flex flex-col gap-3">
                    <div className="flex flex-col text-left">
                        {/* Title with View Details inline */}
                        <div className="flex items-baseline gap-3 mb-3">
                            <h3 className="text-3xl md:text-4xl font-normal text-black leading-[1.1] transition-colors duration-300 group-hover:text-[var(--project-color)] m-0 p-0" style={{ '--project-color': project.color } as React.CSSProperties}>
                                {project.title}
                            </h3>
                            {/* View Details - appears on hover */}
                            <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-2 whitespace-nowrap">
                                <span 
