        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-5 py-11">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    >
                        <h3 className="text-sm font-serif font-semibold text-[#F4A261] mb-4">
                            Quick Links
                        </h3>
                        <ul className="space-y-2">
                            <li>
                                <a href="#about" className="text-xs text-gray-300 hover:text-[#81B4CE] transition-colors duration-300">
                                    About
                                </a>
                            </li>
                            <li>
                                <a href="#works" className="text-xs text-gray-300 hover:text-[#81B4CE] transition-colors duration-300">
                                    Works
                                </a>
                            </li>
                            <li>
                                <a href="#contact" className="text-xs text-gray-300 hover:text-[#81B4CE] transition-colors duration-300">
                                    Contact
                                </a>
                            </li>
                        </ul>
                    ...
                    >
                        <h3 className="text-sm font-serif font-semibold text-[#E07A5F] mb-4">
                            Contact
                        </h3>
                        <ul className="space-y-2">
                            <li className="flex items-center space-x-2">
                                ...
                                <a href="mailto:your.email@example.com" className="text-xs text-gray-300 hover:text-[#81B4CE] transition-colors duration-300">
                    ...
                    >
                        ...
                        <div className="flex space-x-3">
                            ...
                            <motion.a 
                                ...
                                className="w-7 h-7 flex items-center justify-center rounded-full bg-[#1a2634] hover:bg-[#81B4CE] transition-all duration-300 group"
                                aria-label="LinkedIn"
                                whileHover={{ scale: 1.15, rotate: 5 }}
                                whileTap={{ scale: 0.9 }}
                            >
                                <svg className="w-3.5 h-3.5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
